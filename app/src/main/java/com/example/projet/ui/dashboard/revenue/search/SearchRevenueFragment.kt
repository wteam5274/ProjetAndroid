...
class SearchRevenueFragment : Fragment() {

    @Inject
    lateinit var viewModelFactory: AppViewModelFactory
    private val viewModel by lazy { vm(viewModelFactory, SearchRevenueViewModel::class) }
    ...
    override fun onCreateView(
        ...
        rootView = inflater.inflate(R.layout.search_revenue_fragment, container, false)
        return rootView
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        btn_next.setOnClickListener {
            ...
            Navigation.findNavController(rootView).navigate(
                SearchRevenueFragmentDirections.actionSearchRevenueToRevenueList(cin.text.toString())
            )
        }
    ...
    companion object {
        fun newInstance() = SearchRevenueFragment()
    }
}
